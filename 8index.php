...
<body>
    ...
    <form method="GET">
        ...
        <!-- CORRIGIDO: O tipo correto para texto é "text" e não leva "step" -->
    ...
    <?php
    if (isset($_GET["valor1"]) && isset($_GET["valor2"]) && isset($_GET["valor3"]) && isset($_GET["nome"])) {
        ...
        echo "<h2>Olá, " . htmlspecialchars($nome) . "! A soma dos três números é: " . number_format($total, 2, ',', '.') . "</h2>";
    }
    ?>
</body>
</html>